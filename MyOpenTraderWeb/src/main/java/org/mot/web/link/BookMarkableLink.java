...
public class BookMarkableLink extends BookmarkablePageLink<Object> {
	...
	public BookMarkableLink(String id, Class pageClass, String stock,
			String symbol, String PageTitle, String _paramKey,
			String _paramValue, String _wicketHrefTextId, String _hrefText) {
		super(id, pageClass);

	...
	public OverviewTrendPanel(String id) {
	    ...
	    { 
				...
				protected void populateItem(ListItem item) {
					...
					item.add(new BookMarkableLink("symbolLink", StockPage.class, symbol, symbol, symbol + " details", "StockDetails", symbol, "ticker", symbol));
					
					item.add(new Label("ClosePrice", thd.getLastClosingPriceForStock(symbol)));

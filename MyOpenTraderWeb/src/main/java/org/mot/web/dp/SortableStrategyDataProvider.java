...
public class SortableStrategyDataProvider extends SortableDataProvider<Object, Object> {
	...
	public SortableStrategyDataProvider() {
		...
		// (String iD, String name, String type, String symbol, String
		// loadValues, boolean enabled)
		// list.add(new Strategy("99", "Test", "MovingAverage", "FB", "15;77",
		// true));
		// list.add(new Strategy("99", "Test", "Mo2vingAverage", "FB", "15;77",
		// true));
